...
#define AVFMT_AVOID_NEG_TS_MAKE_ZERO         2 ///< Shift timestamps so that they start at 0
    ...
    int max_streams;
    // ylei modify begin
    int64_t xl_priv_flag;//xl flag,now used for supporting mp4 m3u8 HLS mode
    AVIOUpdateCB update_listener; // update parsing progress callback
    HLSURLUpdateCB hls_url_update_callback; //change hls segment's url dynamically
    // yuelei modify end
     ...
     *
     */
    int64_t ff_configure_buffers_for_index_exe_time;

    /**
     *
     */
    int ff_configure_buffers_for_index_flag;
